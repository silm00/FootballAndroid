...
public class AdapterLastMatch extends RecyclerView.Adapter<AdapterLastMatch.ViewHolder> {
    ...
    public AdapterLastMatch(Context context,ApiInterface apiInterface) {
